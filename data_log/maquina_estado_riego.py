...
class InitState(State):
    ...
    def execute(self):
        ...
        add_status_log_entry(AAAA_MM_DD=year_month_day,State= 'Iniciando',tiempo_inicio=init_time, tiempo_actual= init_time , tiempo_termino=init_time, valve0_status=estado_valvula_0, valve1_status=estado_valvula_1, sensormoist0_value=estado_humedad_0, sensormoist1_value=estado_humedad_1)
    ...
    def execute(self):
        ...
        if check_log_time_variable(get_tiempo_actual_csv(year_month_day)):
            ...
            if (estado_humedad_0 < HUMEDAD_MINIMA):
                ...
                add_status_log_entry(AAAA_MM_DD=year_month_day,State= 'EsperandoRiego', tiempo_actual=actual_time, valve0_status=estado_valvula_0, valve1_status=estado_valvula_1, sensormoist0_value=estado_humedad_0, sensormoist1_value=estado_humedad_1)
